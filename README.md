...
- [ ] **10.** 使用 Python 生成类似于下图中的**字母验证码图片**
...
- [ ] **13.**用 Python 写一个爬图片的程序，爬 [这个链接里的日本妹子图片 :-)](http://tieba.baidu.com/p/2166231880)
...
- [ ] **16.** 纯文本文件 numbers.txt, 里面的内容（包括方括号）如下所示：
...
- [ ] **17.** 将 第 0014 题中的 student.xls 文件中的内容写到 student.xml 文件中，如
...
- [ ] **18.** 将 第 0015 题中的 city.xls 文件中的内容写到 city.xml 文件中，如下
所示：
...
- [ ] **19.** 将 第 0016 题中的 numbers.xls 文件中的内容写到 numbers.xml 文件中，如下
...
- [ ] **20.** [登陆中国联通网上营业厅](http://iservice.10010.com/index_.html) 后选择「自助服务」 --> 「详单查询」，然后选择你要查询的时间段，点击「查询」按钮，查询结果页面的最下方，点击「导出」，就会生成类似于 2014年10月01日～2014年10月31日通话详单.xls 文件。写代码，对每月通话时间做个统计。
...
- [ ] **22.** iPhone 6、iPhone 6 Plus 早已上市开卖。请查看你写得 第 0005 题的代码是否可以复用。
...
- [ ] **25.** 使用 Python 实现：对着电脑吼一声,自动打开浏览器中的默认网站。
